...
function historical_data_parser_callback()
{
    ...
    $queried_hist = $wpdb->get_results("SELECT * FROM $secondtable WHERE id_registro =  $queried_data->ID");
    ob_start();
?>
    ...
    <div class="paxs-new-registry-container">
        <div class="paxs-new-registry-info">
            ...
            <div class="label-wrapper">
                <strong>Fecha de Nacimiento:</strong> <span><?php echo $queried_data->fecha_nac; ?></span>
            </div>
            <div class="label-wrapper">
                <strong>Fecha de Vencimiento:</strong> <span><?php echo $queried_data->fecha_ven; ?></span>
            </div>
        </div>
                ...
                <tbody class="historical-body">
                    ...
                    <?php foreach ($queried_hist as $item) { ?>
                        ...
                        <tr class="historical-item <?php echo $number; ?>">
                            ...
                            <td><?php echo $item->fecha_vuelo; ?></td>
...
function replicateHistoricaltable($id)
{
    ...
    $secondtable = $wpdb->prefix . 'paxs_hist_data';
    $queried_hist = $wpdb->get_results("SELECT * FROM $secondtable WHERE id_registro = $id");
    ob_start();
    $i = 1;
